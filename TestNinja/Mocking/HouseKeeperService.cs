...
namespace TestNinja.Mocking
{
    public class HouseKeeperService
    {
        ...
        private readonly IStatmentGenerator _statmentGenerator;
        ...
        public HouseKeeperService(
            ...
            IStatmentGenerator statmentGenerator,
            IEmailSender emailSender,
            IXtraMessageBox messageBox)
        {
            _unitOfWork = unitOfWork;
            _statmentGenerator = statmentGenerator;
        ...
        public void SendStatementEmails(DateTime statementDate)
        {
            ...
            foreach (var housekeeper in housekeepers)
            {
                ...
                var statementFilename = _statmentGenerator.SaveStatement(housekeeper.Oid, housekeeper.FullName, statementDate);
