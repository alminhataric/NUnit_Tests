...
namespace TestNinja.UnitTests.Mocking
{
    ...
    class BookingHelper_OverlappingBookingsExistTests
    {
        ...
        [Test]
        public void BookingStartsBeforeAndFinishesAfterAnExistingBooking_ReturnExistingBookingReferences()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
        ...
        [Test]
        public void BookingStartsAndFinishesInTheMiddleOfAnExistingBookingButFinishesAfter_ReturnExistingBookingReferences()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
